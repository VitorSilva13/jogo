...
from code.const import WIN_WIDTH, COLOR_PURPLE, MENU_OPTION, COLOR_WHITE, COLOR_YELLOW


class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./assets/imagem.png')
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(text_size=50, text="Space Invasion", text_color=COLOR_PURPLE,
